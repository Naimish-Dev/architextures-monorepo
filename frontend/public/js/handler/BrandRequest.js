class BrandRequest {
    ...
    createRequestModal()
    {
        this.requestModal = new CreateElement({tag: "div", "data-modal":"request-modal", class:"modal", children: [
            {tag: "div", class:"modal-window", style: "max-width: 480px;", children: [
                {tag:"div", class: "modal-header", children: [
                    ...
                    {tag: "div", class: "cc s-gap", children: [
                        {tag: "div", class: "beta-label", children: [
                            {tag: "img", class: "beta-img", src: config.cdn + "/icons/experimental2.svg"},
                            "Beta"
                        ]},
                        {tag: "img", src:"https://cdn.architextures.org/icons/x.svg", class:"icon", "data-close":"request-modal"}
                    ]}
                ]},
    ...
    addEventListeners()
    {
        ...
        document.addEventListener("click", (event) => {
            if (event.target === this.requestModal) this.requestModal.style.display = "none";
        });
    }
